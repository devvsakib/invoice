...
<div class="container mb-4 info_form">
   ...
   <div class="block-heading text-white px-3 py-2 rounded fs-5 mb-3">{{$lang_kwords['user_info']['english']}}</div>
   	<div class="bg-white p-4 rounded border">
	      ...
	      <div class="form-block mb-5">
	         <div class="form-row mb-4" style="flex-wrap: wrap;">
	            <div class="label-container">
	               <label class="fs-5 text-nowrap d-block">{{$lang_kwords['legal-name']['english']}} <i class="ri-information-fill tooltip_spn1 tooltip_spn_1"></i><div class="tooltip"><span class="tooltiptext"><small>{{$lang_kwords['name-with-a-legal-form']['english']}}</small></div></span></label>
	            </div>
	         ...
	         <div class="form-row mb-4">
	            ...
	            <div class="field-container"><input type="text" class="form-control" name="vat" id="vat" value="{{ old('vat') }}"/><span class="err_spn vat_err">{{$lang_kwords['please-fill-detail']['english']}}</span></div>
	         </div>
	      </div>
	      <div class="d-flex mb-4">
	      ...
	      <div class="form-block">
	         <div class="form-row mb-4">
	            ...
	            <div class="field-container"><input type="text" class="form-control" name="street" id="street" value="{{ old('street') }}"/><span class="err_spn street_err">{{$lang_kwords['please-fill-detail']['english']}}</span></div>
	         </div>
	         <div class="form-row mb-4">
	            <div class="label-container"><label class="fs-5 text-nowrap d-block">{{$lang_kwords['number']['english']}}</label></div>
	            <div class="field-container"><input type="text" class="form-control" name="number" id="number" value="{{ old('number') }}"/><span class="err_spn number_err">{{$lang_kwords['please-fill-detail']['english']}}</span></div>
	         </div>
	         <div class="form-row mb-4">
	            <div class="label-container"><label class="fs-5 text-nowrap d-block">{{$lang_kwords['postal-code']['english']}}</label></div>
	            <div class="field-container"><input type="text" class="form-control" name="postal" id="postal" value="{{ old('postal') }}"/><span class="err_spn postal_err">{{$lang_kwords['please-fill-detail']['english']}}</span></div>
	         </div>
	         <div class="form-row mb-4">
	         ...
	         <div class="form-row mb-4">
	            <div class="label-container"><label class="fs-5 text-nowrap d-block">{{$lang_kwords['municipality']['english']}}  <span class="rotate spinner" style="display:none" id="prov_spn"></span> </label></div>
	            <div class="field-container">
	         ...
	         <div class="form-row mb-4">
	            <div class="label-container"><label class="fs-5 text-nowrap d-block">{{$lang_kwords['email']['english']}}</label></div>
	         ...
	         <div class="form-row mb-4">
	            ...
	            <span class="err_spn password_err">{{$lang_kwords['please-fill-detail']['english']}}</span></div>
	         </div>
	         <div class="form-row mb-4">
